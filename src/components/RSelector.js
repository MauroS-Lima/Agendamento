...
const PSelector = ({prop}) => {
  ...
  return (
    ...
    > 
    {!(prop.active==='Disponível'||prop.active==='Indisponível') ? <Text style={styles.time}>Ocupado</Text> : prop.hour < 6 ? <Text style={styles.time}>{prop.hour+7}:30</Text>:<Text style={styles.time}>{prop.hour+7}:00</Text>}
